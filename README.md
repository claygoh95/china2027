...
Personal travel dashboard for Yunnan, China, 14–23 May 2027.

## Edit the dashboard

- `dist/index.html`: trip details, flights, and accommodations.
- `dist/style.css`: layout, colours, typography, and mobile styles.
- `dist/app.js`: itinerary dates and day selection.
